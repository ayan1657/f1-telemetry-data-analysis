...
Telemetry is sourced from public broadcast data via FastF1. High-frequency sensor data, fuel load, and car setup parameters are not available. Pit in-laps and out-laps may contain incomplete tyre information
